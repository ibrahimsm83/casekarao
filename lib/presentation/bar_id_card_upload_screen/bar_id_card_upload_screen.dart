            ...
            children: [
                        ...
                        child: GetBuilder<SetupProfileController>(
                          builder: (controller) {
                            ...
                            // Show existing image from profileData if available
                                ...
                                controller.profileData.value!.data.barId_front != null &&
                                controller.profileData.value!.data.barId_front.toString().isNotEmpty) {
                              return ClipRRect(
                                borderRadius: BorderRadius.circular(13.r),
                                child: Image.network(
                                  controller.profileData.value!.data.barId_front.toString(),
                                  fit: BoxFit.cover,
                                  width: double.infinity,
                                  height: double.infinity,
                        ...
                        child: GetBuilder<SetupProfileController>(
                          builder: (controller) {
                            ...
                            // Show existing image from profileData if available
                                ...
                                controller.profileData.value!.data.barId_back != null &&
                                controller.profileData.value!.data.barId_back.toString().isNotEmpty) {
                              return ClipRRect(
                                borderRadius: BorderRadius.circular(13.r),
                                child: Image.network(
                                  controller.profileData.value!.data.barId_back.toString(),
                                  fit: BoxFit.cover,
                                  width: double.infinity,
                                  height: double.infinity,
                                  loadingBuilder: (context, child, loadingProgress) {
              ...
              GetBuilder<SetupProfileController>(
                builder: (controller) {
                  ...
                  return InkWell(
                    onTap: () {
                      // Submit Bar ID cards if at least one image is available
                      if (hasAnyImage) {
